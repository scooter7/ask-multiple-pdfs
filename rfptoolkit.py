...
KEYWORDS = [
"website redesign", "SEO", "search engine optimization", "CRM", "Slate", "Google Analytics", "GA4", "GA 4", "Universal Analytics", "OTT", "blog posts", "blogging", "copy writing", "submitted by",
